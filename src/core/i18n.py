...
TRANSLATIONS = {
    "en": {
        ...
        "manager_select_format": "{name} – Select Format",
    ...
    "id": {
        ...
        "manager_select_format": "{name} – Pilih Format",
        ...
        "cache_details": "Rincian file yang dibersihkan:",
