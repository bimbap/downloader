#!/usr/bin/env bash
# =============================================================================
# yt.sh – Interactive Launcher for YouTube Downloader
# =============================================================================
...
if ! $PY_CMD -c "import yt_dlp, imageio_ffmpeg" >/dev/null 2>&1; then
    echo ""
...
if [ "$#" -eq 0 ]; then
    $PY_CMD "$SCRIPT_DIR/src/tui.py"
else
    $PY_CMD "$SCRIPT_DIR/src/downloader.py" "$@"
fi
